    ...
    <footer className="bg-primary-dark text-white border-t-2 border-highlight">
        ...
        >
          ...
          <motion.div variants={columnVariants}>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 text-gray-400 hover:text-accent text-sm transition-colors">
              ...
              <li>
                <a href={`mailto:${SITE.email}`} className="flex items-start gap-3 text-gray-400 hover:text-accent text-sm transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/contato" className="text-gray-400 hover:text-accent text-sm transition-colors">
                  Ouvidoria
                </Link>
              </li>
              <li>
                <a href={PORTALS.cliente} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-accent text-sm transition-colors">
                  2ª via boleto
                </a>
              </li>
            </ul>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 lg:px-6 py-5 flex flex-col gap-4">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-gray-400 border-t border-white/5 pt-4">
