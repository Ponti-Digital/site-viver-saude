...
export function Header() {
  ...
  return (
    <>
      {/* Top utility bar — verde profundo com fio dourado no topo */}
      <div className="bg-primary-dark text-white/90 text-sm hidden lg:block border-t-2 border-highlight">
        <div className="max-w-7xl mx-auto px-6 py-1.5 flex items-center justify-between">
          <div className="flex items-center gap-5">
            <a href={`tel:${SITE.phone}`} className="flex items-center gap-1.5 font-medium hover:text-white transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-highlight" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
